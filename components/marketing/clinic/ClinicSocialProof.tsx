...
export default function ClinicSocialProof() {
    const t = useTranslations("Clinic.SocialProof");
    ...
    const stats = [
        { target: 600, suffix: "+", label: t("stat0label") },
        { target: 12, suffix: "+", label: t("stat1label") },
